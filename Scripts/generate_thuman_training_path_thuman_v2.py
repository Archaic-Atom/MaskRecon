...
TRAIN_LIST_PATH = './Datasets/thuman_training_list_434.csv'
VAL_TRAINLIST_PATH = './Datasets/thuman_testing_val_list_434.csv'

# IMG_NUM = 194  # the dataset's total image
IMG_NUM = 100    # the dataset's total image
TIMES = 100000      # the sample of val
...
def gen_list(fd_train_list, fd_val_train_list):
    ...
    filePath = 'G:\\lx\\Datasets\\thuman_fb_v2\\human_fb_train\\DEPTH'
