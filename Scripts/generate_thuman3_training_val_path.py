...
# define sone struct
ROOT_PATH = '/data1/datasets/Thuman/'  # root path

# the file's path and format
RAW_DATA_FOLDER = 'thuman3_fb/train/'
RGB_FOLDER = 'RENDER/%s/'
DEPTH_FOLDER = 'DEPTH/%s/'
UV_FOLDER = 'uv/%s/'
FILE_NAME = '%04d_0_00'
UV_FILE_NAME = 'dp.%04d'
DT_DATA_FOLDER = 'thuman3_fb/groundtruth/'
...
# the output's path,
TRAIN_LIST_PATH = './Datasets/thuman3_training_list.csv'
VAL_TRAINLIST_PATH = './Datasets/thuman3_val_list.csv'
...
def gen_list(fd_train_list, fd_val_train_list):
    ...
    filePath = '/data1/datasets/Thuman/thuman3_fb/train/RENDER'
